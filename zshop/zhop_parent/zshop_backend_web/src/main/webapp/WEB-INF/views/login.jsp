...
<head>
    ...
    <link rel="stylesheet" href="${APP_PATH}/css/mycss.css"/>
...
<div class="container div-signin">
    <div class="panel panel-primary div-shadow">
        ...
        <div class="panel-body">
            <!-- login form start -->
            <form action="${APP_PATH}/backend/sysuser/login" class="form-horizontal" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <!-- 验证码 -->
                        <img class="img-rounded" src="${APP_PATH}/images/image.jpg" style="height: 32px; width: 70px;"/>
                    </div>
                    <div class="col-sm-2">
