...
<head>
    ...
    <link rel="stylesheet" href="${APP_PATH}/css/file.css"/>
    ...
    <script src="https://cdn.bootcss.com/bootstrap-validator/0.4.5/js/bootstrapvalidator.min.js"></script>
    <script src="${APP_PATH}/layer/layer.js"></script>
    <link rel="stylesheet" href="${APP_PATH}/css/zshop.css"/>
    <link href="https://cdn.bootcss.com/bootstrap-validator/0.4.5/css/bootstrapvalidator.min.css" rel="stylesheet">
...
<div class="modal fade" tabindex="-1" id="Product">
    ...
    <div class="modal-dialog modal-lg">
        <!-- 内容声明 -->
        <form action="${APP_PATH}/backend/product/add" class="form-horizontal" method="post" enctype="multipart/form-data">
