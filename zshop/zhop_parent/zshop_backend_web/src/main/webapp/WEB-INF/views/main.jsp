    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#product-type-set").click(function () {
                $("#frame-id").attr("src", "${APP_PATH}/backend/productType/findAll");
            });
            $("#product-set").click(function () {
                $("#frame-id").attr("src", "${APP_PATH}/backend/product/findAll");
            });
        ...
        <div class="container-flude flude-cc" id="a">
            <div class="row user-setting">
                ...
                <div class="col-xs-10" id="userPanel">
                    <iframe id="frame-id" src="${APP_PATH}/backend/productType/findAll" width="100%" height="100%"
                            frameborder="0"
                            scrolling="no">
                    </iframe>
                </div>
